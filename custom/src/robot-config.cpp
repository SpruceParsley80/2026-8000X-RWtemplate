...
motor right_chassis3 = motor(PORT14, ratio6_1, true);


inertial inertial_sensor = inertial(PORT21);
optical example_optical_sensor = optical(PORT6);
distance example_distance_sensor = distance(PORT7);
...
distance left_sensor = distance(PORT2);
